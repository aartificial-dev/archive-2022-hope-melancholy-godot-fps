...
[Tool]
public class RichLabel3D : Spatial { 
    ...
    public override void _Ready() {
        ...
        label = GetNode<RichTextLabel>("Viewport/Control/RichTextLabel");
    ...
    private void ChangeText() {
        ...
        label.BbcodeText = GD.Str("[center]", text, "[/center]");
    ...
    private void ChangeLabel() {
        ...
        label.Set("custom_colors/default_color", textColor);
