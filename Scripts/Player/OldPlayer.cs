...
public class OldPlayer : KinematicBody { 
    ...
    private OldPlayerCamera camera;
    private OldPlayerStats playerStats = new OldPlayerStats();
    ...
    public override void _Ready() {
        camera = GetNode<OldPlayerCamera>("PlayerCamera");
